...
def generate_edge_case_events() -> list:
    ...
    return [
        ...
        {
            "ticker": "AAPL", "crypto_id": "AAPL",
            "price_usd": 0.0001, "price": 0.0001,
            "open": 0.0001, "high": 0.0001, "low": 0.0001, "close": 0.0001,
            "volume": 1000, "change_24h_pct": 0.0, "timestamp": ts,
        },
        # 2. Price exactly 999999.99 (maximum valid)
        {
            "ticker": "AAPL", "crypto_id": "AAPL",
            "price_usd": 999999.99, "price": 999999.99,
            "open": 999999.99, "high": 999999.99, "low": 999999.99, "close": 999999.99,
            "volume": 10000000, "change_24h_pct": 0.0, "timestamp": ts,
        },
        # 3. Volume exactly 0 (boundary)
        {
            "ticker": "MSFT", "crypto_id": "MSFT",
            "price_usd": 100.0, "price": 100.0,
            "open": 100.0, "high": 100.0, "low": 100.0, "close": 100.0,
            "volume": 0, "change_24h_pct": 0.0, "timestamp": ts,
        },
        # 4. change_24h_pct exactly 10.0 (alert boundary)
        {
            "ticker": "GOOGL", "crypto_id": "GOOGL",
            "price_usd": 100.0, "price": 100.0,
            "open": 100.0, "high": 110.0, "low": 99.0, "close": 100.0,
            "volume": 1000000, "change_24h_pct": 10.0, "timestamp": ts,
        },
        # 5. change_24h_pct exactly -10.0 (alert boundary)
        {
            "ticker": "AMZN", "crypto_id": "AMZN",
            "price_usd": 100.0, "price": 100.0,
            "open": 100.0, "high": 101.0, "low": 90.0, "close": 100.0,
            "volume": 1000000, "change_24h_pct": -10.0, "timestamp": ts,
        },
        # 6. All fields at minimum values
        {
            "ticker": "TSLA", "crypto_id": "TSLA",
            "price_usd": 0.0001, "price": 0.0001,
            "open": 0.0001, "high": 0.0001, "low": 0.0001, "close": 0.0001,
            "volume": 0, "change_24h_pct": -20.0, "timestamp": ts,
        },
        # 7. All fields at maximum values
        {
            ...
            "price_usd": 999999.99, "price": 999999.99,
            "open": 999999.99, "high": 999999.99, "low": 999999.99, "close": 999999.99,
            "volume": 10000000, "change_24h_pct": 20.0, "timestamp": ts,
        },
    ]
